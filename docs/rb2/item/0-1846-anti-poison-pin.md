---
title: "Anti-Poison Pin (Item) - Hyperdimension Neptunia Re;Birth2"
---
...
- [Dungeons **Anti-Poison Pin** is found](#dungeons-anti-poison-pin-is-found)
- [Quests which reward **Anti-Poison Pin**](#quests-which-reward-anti-poison-pin)
- [Player characters who can equip **Anti-Poison Pin**](#player-characters-who-can-equip-anti-poison-pin)
...
| **Name** | Anti-Poison Pin |
| **Type** | Ornament |
| **Description** | A pin that fully protects its wearer from being poisoned. |
| **Buy Price** | 20000 |
| **Sell Price** | 2000 |
| **Max inventory** | 99 |
| **To unlock in shop** | Method 1<br />- View scene [Chapter 4](/neptunia/rb2/scene/0-301-chapter-4.html) |

## Dungeons **Anti-Poison Pin** is found
...
## Quests which reward **Anti-Poison Pin**

|    | ID | DLC | Name |
| -- | -- | --- | ---- |
| <input type="checkbox" id="rb2-quest-0-25" class="trackbox" /> | 25 | [Base](/neptunia/rb2/dlc/0-base.html) | [Outburst](/neptunia/rb2/quest/0-25-outburst.html) |

## Player characters who can equip **Anti-Poison Pin**
