---
title: "Hitting Patch (Item) - Hyperdimension Neptunia Re;Birth2"
---
...
- [Stats](#stats)
- [Monsters which drop **Hitting Patch**](#monsters-which-drop-hitting-patch)
- [Dungeons **Hitting Patch** is found](#dungeons-hitting-patch-is-found)
- [Quests which reward **Hitting Patch**](#quests-which-reward-hitting-patch)
- [Player characters who can equip **Hitting Patch**](#player-characters-who-can-equip-hitting-patch)
...
| **Name** | Hitting Patch |
| **Type** | Ornament |
| **Description** | Increases TEC. When worn, it increases your attack accuracy. |
| **Buy Price** | 10000 |
| **Sell Price** | 1000 |
| **Max inventory** | 99 |
...
## Monsters which drop **Hitting Patch**
...
## Dungeons **Hitting Patch** is found
...
## Quests which reward **Hitting Patch**

|    | ID | DLC | Name |
| -- | -- | --- | ---- |
| <input type="checkbox" id="rb2-quest-0-76" class="trackbox" /> | 76 | [Base](/neptunia/rb2/dlc/0-base.html) | [Narumidrop](/neptunia/rb2/quest/0-76-narumidrop.html) |

## Player characters who can equip **Hitting Patch**
