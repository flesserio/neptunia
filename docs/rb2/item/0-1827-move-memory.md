---
title: "Move Memory (Item) - Hyperdimension Neptunia Re;Birth2"
---
...
- [Dungeons **Move Memory** is found](#dungeons-move-memory-is-found)
- [Quests which reward **Move Memory**](#quests-which-reward-move-memory)
...
| **Name** | Move Memory |
| **Type** | Ornament |
| **Description** | Increases MOV. This will widen your range of movement. |
| **Buy Price** | 1000 |
| **Sell Price** | 100 |
| **Max inventory** | 99 |
| **To unlock in shop** | Method 1<br />- View scene [Chapter 1](/neptunia/rb2/scene/0-51-chapter-1.html) |

## Dungeons **Move Memory** is found
...
## Quests which reward **Move Memory**

|    | ID | DLC | Name |
| -- | -- | --- | ---- |
| <input type="checkbox" id="rb2-quest-0-10" class="trackbox" /> | 10 | [Base](/neptunia/rb2/dlc/0-base.html) | [Protect Neptune](/neptunia/rb2/quest/0-10-protect-neptune.html) |
