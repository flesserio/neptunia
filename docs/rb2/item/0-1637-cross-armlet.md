---
title: "Cross Armlet (Item) - Hyperdimension Neptunia Re;Birth2"
---
...
- [Stats](#stats)
- [Dungeons **Cross Armlet** is found](#dungeons-cross-armlet-is-found)
- [Quests which reward **Cross Armlet**](#quests-which-reward-cross-armlet)
...
| **Name** | Cross Armlet |
| **Type** | Armor |
| **Description** | An armlet made by a famous brand with a big cross symbol. |
| **Buy Price** | 10000 |
| **Sell Price** | 1000 |
| **Max inventory** | 99 |
...
| -- | -- | --- | --- | --- | --- | --- | --- | --- | --- | --------- | -------- | --------- | -------------- |
| 0 | 0 | 0 | 0 | 363 | 0 | 451 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

## Dungeons **Cross Armlet** is found
...
## Quests which reward **Cross Armlet**

|    | ID | DLC | Name |
| -- | -- | --- | ---- |
| <input type="checkbox" id="rb2-quest-0-57" class="trackbox" /> | 57 | [Base](/neptunia/rb2/dlc/0-base.html) | [No Forgiveness](/neptunia/rb2/quest/0-57-no-forgiveness.html) |

## Player characters who can equip **Cross Armlet**
