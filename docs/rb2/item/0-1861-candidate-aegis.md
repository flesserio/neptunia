---
title: "Candidate Aegis (Item) - Hyperdimension Neptunia Re;Birth2"
---
...
- [Stats](#stats)
- [Monsters which drop **Candidate Aegis**](#monsters-which-drop-candidate-aegis)
- [Colosseum quests which reward **Candidate Aegis**](#colosseum-quests-which-reward-candidate-aegis)
- [Player characters who can equip **Candidate Aegis**](#player-characters-who-can-equip-candidate-aegis)
...
| **Name** | Candidate Aegis |
| **Type** | Ornament |
| **Description** | A mysterious ring the CPU Candidates created. Their blessings are sealed within it, so it protects you from all kinds of attacks. |
| **Buy Price** | 5000 |
| **Sell Price** | 500 |
| **Max inventory** | 99 |
...
## Monsters which drop **Candidate Aegis**
...
## Colosseum quests which reward **Candidate Aegis**
...
## Player characters who can equip **Candidate Aegis**
