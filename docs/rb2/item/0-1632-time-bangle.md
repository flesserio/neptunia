---
title: "Time Bangle (Item) - Hyperdimension Neptunia Re;Birth2"
---
...
- [Monsters which drop **Time Bangle**](#monsters-which-drop-time-bangle)
...
| **Name** | Time Bangle |
| **Type** | Armor |
| **Description** | A monotone bangle designed by the best artisan in Planeptune. |
| **Buy Price** | 5000 |
| **Sell Price** | 500 |
| **Max inventory** | 99 |
...
| -- | -- | --- | --- | --- | --- | --- | --- | --- | --- | --------- | -------- | --------- | -------------- |
| 0 | 0 | 183 | 0 | 242 | 0 | 337 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
## Monsters which drop **Time Bangle**
